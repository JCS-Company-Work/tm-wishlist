<?php
    ...
    class TMWL_Main {
        ...
        public function render_view_wishlist_button() {
            ...
            printf(
                '<a href="/wishlist" id="view-wishlist" class="tm-add-to-compare btn btn-outline-secondary btn-sm button level-02" data-product-id="%d" role="button" aria-pressed="false">%s</a>',
